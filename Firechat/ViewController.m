...
#define kFirechatNS @"https://hauschat.firebaseio.com/"
...
- (void)viewDidLoad
{
    ...
    self.users = [[Firebase alloc] initWithUrl:@"https://hauschat.firebaseio.com/users"];
    self.messages = [[Firebase alloc] initWithUrl:@"https://hauschat.firebaseio.com/chat/room"];
    
    // set the user name and view title
    self.name = @"Artist";
    [nameField setTitle:self.name forState:UIControlStateNormal];
    
    
    // observe messages as they are added to the firebase list
...
- (BOOL)textFieldShouldReturn:(UITextField*)aTextField
{
    ...
    [[self.messages childByAutoId] setValue:@{@"pokemon" : self.name, @"text": aTextField.text, @"position": @50}];
...
- (UITableViewCell*)tableView:(UITableView*)table cellForRowAtIndexPath:(NSIndexPath *)index
{
    ...
    cell.detailTextLabel.text = chatMessage[@"pokemon"];
